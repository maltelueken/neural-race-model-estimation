...
from confrdm.simulators.rdmc import sample_rdmc_prior_two_accumulators, simulate_rdmc_two_accumulators
...
def main(cfg: DictConfig):
    ...
    def prior_fun():
        return sample_rdmc_prior_two_accumulators(**prior_args)

    def experiment_fun(**kwargs):
        return simulate_rdmc_two_accumulators(**kwargs, **experiment_args)
